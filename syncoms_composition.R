...
# Remove species with no counts
ot_selected_filtered <- filter_features_by_counts_col_counts(otu_table_selected,min_count = 5, col_number = 1)
...
sc7_sel <- dplyr::left_join(tibble::rownames_to_column(sc7[11], var = "bacteria"),
...
sc12_sel <- dplyr::left_join(rownames_to_column(sc12[11], var = "bacteria"),
...
sc20_sel <- dplyr::left_join(rownames_to_column(sc20[11], var = "bacteria"),
...
sc28_sel <- dplyr::left_join(rownames_to_column(sc28[11], var = "bacteria"),
...
sc43_sel <- dplyr::left_join(rownames_to_column(sc43[11], var = "bacteria"),
...
barplots_grid(feature_tables = list(sc7_sel, sc12_sel, sc20_sel, sc28_sel, sc43_sel),
              ...
              x_axis_title_size = 10, x_axis_text_size = 6,
              y_axis_title_size = 10, y_axis_text_size = 6,
              legend_pos = "right", legend_cols = 1,
              legend_title_size = 9, legend_text_size = 7,
              legend_key_size = 0.3, colour_palette = colours_vec)
